...
#Now fully randomize, not implemented yet
#while($currentScore < 16000){
#	$printValue = int(rand(3));
#	$firstQuestion = int(rand(2));	
#
#	#ouput in decimal
#	if($printValue == 0 && $firstQuestion == 0){
#		$strOption1 = "hex";
#		$strOption2 = "binary";
#	}
#	if($printValue == 0 && $firstQuestion == 1){
#		$strOption1 = "binary";
#		$strOption2 = "hex";
#	}
#
#	printf "What is this value in %s?", $strOption1;
#
#	chomp($userInput = <STDIN>);
#	if($userInput eq 'q'){
#		$currentScore = $currentScore / 100;
...
#		print "You lost 200 points, and now have $currentScore points\n";
#	}
#	printf "What is this value in %s?", $strOption2;
#}
